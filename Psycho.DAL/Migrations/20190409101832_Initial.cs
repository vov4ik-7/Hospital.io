        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDataTime = table.Column<DateTime>(nullable: true),
                    EndDataTime = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_AuthorizedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_AuthorizedUserId",
                        column: x => x.AuthorizedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkSchedules_AspNetUsers_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IsHealth = table.Column<bool>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentResults_Appointments_NextAppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentResults_NextAppointmentId",
                table: "AppointmentResults",
                column: "NextAppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AuthorizedUserId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_AuthorizedUserId",
                table: "Reports",
                column: "AuthorizedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkSchedules_PsychologistId_Day",
                table: "WorkSchedules",
                columns: new[] { "PsychologistId", "Day" },
                unique: true);
        }
